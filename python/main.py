...
sessions_buids_attributes={'_id':'varchar(255)','session_start':'varchar(255)','session_end':'varchar(255)','has_sale':'varchar(255)','buid':'varchar(255)'}
recommendation_attributes={'_id':'varchar(255)','timestamp':'varchar(255)','segment':'varchar(255)','latest_visit':'varchar(255)'}
similar_product_attribute={'v_id':'varchar(255)','p_id':'varchar(255)'}
...
Manage_Tables.create_table(conn,'sessions',sessions_buids_attributes,primary_key='_id', foreign_key=False)
...
Manage_Tables.create_table(conn,'similar_product',similar_product_attribute,primary_key='v_id,p_id', foreign_key={'v_id':'recommendation(_id)'})
...
Insertion.newInsertion_visitors(conn,coll1='visitors',coll2='visitors_buids',coll3='recommendation',coll4='similar_product',data_input=data_list_visitors,attributes=visitors_attributes,attributes2=visitors_buids_attributes,attributes3=recommendation_attributes,attributes4=similar_product_attribute,fk='_id')
Insertion.newInsertion_sessions(conn,coll1='sessions',coll2='order_products',data_input=data_list_sessions,attributes=sessions_buids_attributes,attributes2=order_products_attributes,fk='_id')
