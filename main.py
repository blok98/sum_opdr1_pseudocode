...
qry_columns = '_id varchar(255) PRIMARY KEY, latest_activity varchar(255), latest_visit varchar(255)'
Manage_Tables.create_table(conn,'visitors',qry_columns)

qry_columns = 'v_id varchar(255) REFERENCES visitors(_id),buid varchar(255) UNIQUE, PRIMARY KEY(v_id,buid)'
Manage_Tables.create_table(conn,'visitors_buids',qry_columns)

qry_columns = '_id varchar(255) PRIMARY KEY,session_start varchar(255), session_end varchar(255), has_sale varchar(255), cg_created varchar(255), tg_created varchar(255),buid varchar(255) REFERENCES visitors_buids(buid)'
...
# Insertion.insertion_visitors(conn, data_list_visitors,data_list_sessions)
#Insertion.insertion_sessions(conn,data_list_sessions,visitors_id_list)
